...
function openWhatsApp() {
    const message = encodeURIComponent("Hi Aditya! I'm interested in your digital marketing services. Let's discuss how you can help grow my business.");
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const animateElements = document.querySelectorAll('.service-card, .testimonial-card, .case-study, .spec-item');
...
// Add some interactive elements enhancement
document.addEventListener('DOMContentLoaded', () => {
